...
Light_t Light_metal_box_geo_0x8023988 = {
{ 255, 255, 255}, 0, { 255, 255, 255}, 0, { 40, 40, 40}, 0
};

Ambient_t Light_metal_box_geo_0x8023980 = {
{127, 127, 127}, 0, {127, 127, 127}, 0
};

Gfx DL_metal_box_geo_0x8024bb8[] = {
gsDPPipeSync(),
...
Gfx DL_metal_box_geo_0x8024b18[] = {
...
gsDPSetTile(0, 2, 8, 0, 0, 0, 0, 6, 0, 0, 5, 0),
gsDPSetTileSize(0, 0, 0, 124, 252),
gsSPDisplayList(DL_metal_box_dl_0x8024b18),
gsSPTexture(65535, 65535, 0, 0, 0),
gsDPPipeSync(),
gsDPSetCombineLERP(0, 0, 0, SHADE, 0, 0, 0, SHADE, 0, 0, 0, SHADE, 0, 0, 0, SHADE),
gsSPGeometryMode(0, G_SHADING_SMOOTH),
...
Gfx DL_metal_box_dl_0x8024b18[] = {
gsDPSetTextureImage(0, 2, 1, metal_box_geo__texture_08023998),
gsDPLoadSync(),
gsDPLoadBlock(7, 0, 0, 2047, 256),
gsSPLight(&Light_metal_box_geo_0x8023988.col, 1),
gsSPLight(&Light_metal_box_geo_0x8023980.col, 2),
gsSPVertex(VB_metal_box_dl_0x8024998, 16, 0),
gsSP2Triangles(0, 1, 2, 0,0, 2, 3, 0),
gsSP2Triangles(4, 5, 6, 0,4, 6, 7, 0),
gsSP2Triangles(8, 9, 10, 0,8, 10, 11, 0),
gsSP2Triangles(12, 13, 14, 0,12, 14, 15, 0),
gsSPVertex(VB_metal_box_dl_0x8024a98, 8, 0),
gsSP2Triangles(0, 1, 2, 0,0, 3, 1, 0),
gsSP2Triangles(4, 5, 6, 0,4, 6, 7, 0),
gsSPEndDisplayList(),
};
