...
{{{ -101, 202, -101 }, 0, { -3088, 1008 }, { 129, 0, 0, 255}}},
{{{ -101, 0, 101 }, 0, { -2064, -16 }, { 129, 0, 0, 255}}},
{{{ -101, 202, 101 }, 0, { -2064, 1008 }, { 129, 0, 0, 255}}},
{{{ 101, 202, -101 }, 0, { -2064, -16 }, { 0, 127, 0, 255}}},
{{{ -101, 202, 101 }, 0, { -3088, 1008 }, { 0, 127, 0, 255}}},
{{{ 101, 202, 101 }, 0, { -3088, -16 }, { 0, 127, 0, 255}}},
{{{ -101, 202, -101 }, 0, { -2064, 1008 }, { 0, 127, 0, 255}}},
{{{ -101, 202, 101 }, 0, { -3088, 1008 }, { 0, 127, 0, 255}}},
{{{ 101, 202, -101 }, 0, { -2064, -16 }, { 0, 127, 0, 255}}},
...
{{{ -101, 202, 101 }, 0, { -3088, 1008 }, { 0, 0, 127, 255}}},
{{{ 101, 0, 101 }, 0, { -2064, -16 }, { 0, 0, 127, 255}}},
{{{ 101, 202, -101 }, 0, { -3088, 1008 }, { 0, 0, 129, 255}}},
{{{ 101, 0, -101 }, 0, { -3088, -16 }, { 0, 0, 129, 255}}},
{{{ -101, 202, -101 }, 0, { -2064, 1008 }, { 0, 0, 129, 255}}},
{{{ -101, 202, -101 }, 0, { -2064, 1008 }, { 0, 0, 129, 255}}},
{{{ 101, 0, -101 }, 0, { -3088, -16 }, { 0, 0, 129, 255}}},
{{{ -101, 0, -101 }, 0, { -2064, -16 }, { 0, 0, 129, 255}}},
{{{ 101, 0, 101 }, 0, { -3088, -16 }, { 0, 129, 0, 255}}},
{{{ -101, 0, 101 }, 0, { -2064, -16 }, { 0, 129, 0, 255}}},
{{{ 101, 0, -101 }, 0, { -3088, 1008 }, { 0, 129, 0, 255}}},
{{{ 101, 0, -101 }, 0, { -3088, 1008 }, { 0, 129, 0, 255}}},
{{{ -101, 0, 101 }, 0, { -2064, -16 }, { 0, 129, 0, 255}}},
...
{{{ 101, 202, -101 }, 0, { -2064, 1008 }, { 127, 0, 0, 255}}},
{{{ 101, 202, 101 }, 0, { -3088, 1008 }, { 127, 0, 0, 255}}},
{{{ 101, 0, -101 }, 0, { -2064, -16 }, { 127, 0, 0, 255}}},
...
Light_t Light_bubbly_tree_geo_0x302de28 = {
{ 255, 255, 255}, 0, { 255, 255, 255}, 0, { 127, 127, 127}, 0
};

Ambient_t Light_bubbly_tree_geo_0x302de30 = {
{127, 127, 127}, 0, {127, 127, 127}, 0
};

Gfx DL_bubbly_tree_geo_0x302e948[] = {
gsDPPipeSync(),
...
gsSPVertex(VB_bubbly_tree_geo_0x302e678, 15, 0),
gsSP2Triangles(0, 1, 2, 0,3, 4, 5, 0),
gsSP2Triangles(6, 7, 8, 0,9, 10, 11, 0),
gsSP1Triangle(12, 13, 14, 0),
gsSPVertex(VB_bubbly_tree_geo_0x302e768, 15, 0),
gsSP2Triangles(0, 1, 2, 0,3, 4, 5, 0),
gsSP2Triangles(6, 7, 8, 0,9, 10, 11, 0),
gsSP1Triangle(12, 13, 14, 0),
gsSPVertex(VB_bubbly_tree_geo_0x302e858, 15, 0),
gsSP2Triangles(0, 1, 2, 0,3, 4, 5, 0),
gsSP2Triangles(6, 7, 8, 0,9, 10, 11, 0),
gsSP1Triangle(12, 13, 14, 0),
gsDPPipeSync(),
...
Light_t Light_spiky_tree_geo_0x302a6e0 = {
{ 255, 255, 255}, 0, { 255, 255, 255}, 0, { 40, 40, 40}, 0
};

Ambient_t Light_spiky_tree_geo_0x302a6d8 = {
{63, 63, 63}, 0, {63, 63, 63}, 0
};

Gfx DL_spiky_tree_geo_0x302f850[] = {
gsDPPipeSync(),
...
gsSPDisplayList(DL_spiky_tree_geo_0x302b7b0),
gsDPPipeSync(),
...
Light_t Light_spiky_tree_geo_0x302b910 = {
{ 255, 255, 255}, 0, { 255, 255, 255}, 0, { 40, 40, 40}, 0
};

Ambient_t Light_spiky_tree_geo_0x302b908 = {
{63, 63, 63}, 0, {63, 63, 63}, 0
};

Gfx DL_spiky_tree_geo_0x302ba18[] = {
gsDPPipeSync(),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, TEXEL0, 0, SHADE, 0, TEXEL0, 0, SHADE, 0, TEXEL0, 0, SHADE, 0),
...
gsDPSetTileSize(0, 0, 0, 124, 124),
gsSPDisplayList(DL_spiky_tree_geo_0x302b9c0),
gsSPTexture(65535, 65535, 0, 0, 0),
gsDPPipeSync(),
gsDPSetCombineLERP(0, 0, 0, SHADE, 0, 0, 0, SHADE, 0, 0, 0, SHADE, 0, 0, 0, SHADE),
...
Gfx DL_spiky_tree_geo_0x302b9c0[] = {
...
Gfx DL_snow_tree_geo_0x302f850[] = {
gsDPPipeSync(),
gsSPGeometryMode(0, G_TEXTURE_GEN),
gsDPSetEnvColor(255, 255, 255, 255),
gsDPSetCombineLERP(0, 0, 0, TEXEL0, 0, 0, 0, ENVIRONMENT, 0, 0, 0, TEXEL0, 0, 0, 0, ENVIRONMENT),
...
gsDPSetTileSize(0, 0, 0, 124, 252),
gsSPTexture(1984, 1984, 0, 0, 1),
gsSPDisplayList(DL_snow_tree_geo_0x302b7b0),
gsDPPipeSync(),
gsSPTexture(1984, 1984, 0, 0, 0),
gsSPGeometryMode(G_TEXTURE_GEN, 0),
gsDPSetEnvColor(255, 255, 255, 255),
...
Gfx DL_snow_tree_geo_0x302ba18[] = {
gsDPPipeSync(),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, TEXEL0, 0, SHADE, 0, TEXEL0, 0, SHADE, 0, TEXEL0, 0, SHADE, 0),
gsSPGeometryMode(G_SHADING_SMOOTH, 0),
gsDPSetTile(0, 2, 0, 0, 7, 0, 0, 0, 0, 0, 0, 0),
...
gsDPSetTile(0, 2, 8, 0, 0, 0, 2, 5, 0, 2, 5, 0),
gsDPSetTileSize(0, 0, 0, 124, 124),
gsSPDisplayList(DL_snow_tree_geo_0x302b9c0),
gsSPTexture(65535, 65535, 0, 0, 0),
gsDPPipeSync(),
gsDPSetCombineLERP(0, 0, 0, SHADE, 0, 0, 0, SHADE, 0, 0, 0, SHADE, 0, 0, 0, SHADE),
gsSPGeometryMode(0, G_SHADING_SMOOTH),
...
Gfx DL_snow_tree_geo_0x302b9c0[] = {
gsDPSetTextureImage(0, 2, 1, spiky_tree_geo__texture_0302AEF0),
gsDPLoadSync(),
gsDPLoadBlock(7, 0, 0, 1023, 256),
gsSPLight(&Light_spiky_tree_geo_0x302b910.col, 1),
