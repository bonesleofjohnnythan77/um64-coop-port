...
local function exclamation_box_act_breaking(obj)
    ...
    obj.header.gfx.scale.x = obj.oExclamationBoxUnkF4 * 2.75
    obj.header.gfx.scale.y = obj.oExclamationBoxUnkF8 * 2.75
    obj.header.gfx.scale.z = obj.oExclamationBoxUnkF4 * 2.75
...
local function exclamation_box_act_broken(obj)
    ...
    play_sound(SOUND_GENERAL_POUND_WOOD_POST, obj.header.gfx.cameraToObject)
